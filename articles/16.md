I've released a new version of [`image-to-ascii`](https://github.com/IonicaBizau/image-to-ascii) NodeJS package that is used for converting images into ASCII art.
