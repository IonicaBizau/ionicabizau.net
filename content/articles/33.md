...
Its name stands for ***n**eed **p**ray **m**ore* (or *nuclear pizza machine*, or *npm's pretty magical* etc etc). **Whaaat?!** Well, if you are here and think that *npm* stands for *Node Package Manager*, I have to tell you that's also correct, but it's not complete. *npm* is not an acronym, but it's a recursive bacronym for *npm is not an acronym*. In short, *npm* is an bacronym, not an acronym like many people believe.
