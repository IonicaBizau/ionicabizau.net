...
We have to create a GitHub repository. I use [`ghrepo`](https://github.com/mattdesl/ghrepo) by [**@mattdesl**] (thanks! :cake: :grin:). It's smart enough to create the GitHub repository with the right data (taken from the local git repository url and `package.json`).
