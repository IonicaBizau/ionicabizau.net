...
It's been more than one year since started teaching people to code. I do it on [CodeMentor](https://codementor.io/johnnyb). In general, we set up 1:1 live sessions and start talking. :smile: Then get the everything fixed and finally both we are happy.
